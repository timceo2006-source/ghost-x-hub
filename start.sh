...
while true; do
    ...
    case $opt in
        ...
        5)
            ...
            clear
            echo -e "${CYAN}====================================${RESET}"
            echo -e "${YELLOW}  Cookie Health Check${RESET}"
            echo -e "${CYAN}====================================${RESET}"
            echo -e "  [1] Check Normal Mode Cookies"
            echo -e "  [2] Check Auto-Switch Cookies"
            echo -e "  [3] Check ALL Cookies"
            echo -e "  [0] Back to Main Menu"
            echo -e "${CYAN}====================================${RESET}"
            read -p "  Select: " chk_opt
            case $chk_opt in
                1) check_normal_mode ;;
                2) check_switch_mode ;;
                3) check_all_mode ;;
