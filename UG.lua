...
-- ==================== สร้าง GUI ปุ่มเปิด-ปิด และตัวนับเวลา ====================
...
mainFrame.Size = UDim2.new(0, 200, 0, 115) -- ขยายขนาด GUI เล็กน้อยให้พอดีกับข้อความบอกเวลา
...
-- ระบบวนลูปสร้างและเข้าดันเจี้ยนอัตโนมัติเมื่ออยู่ Lobby พร้อมแสดงเวลานับถอยหลังบน GUI
task.spawn(function()
    while true do
        if getgenv().AutoCreateAndStart then
            pcall(function()
                ...
                if startDungeonRemote then
                    -- นับถอยหลัง 5 วินาทีก่อนกดสตาร์ท พร้อมแสดงผลบน GUI
                    for i = 5, 1, -1 do
