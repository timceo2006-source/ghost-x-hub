...
-- ระบบวนลูปสร้างและเข้าดันเจี้ยนอัตโนมัติเมื่ออยู่ Lobby (เพิ่มการรอโหลดรีโมทให้เสถียรขึ้น)
task.spawn(function()
    while true do
        if getgenv().AutoCreateAndStart then
            pcall(function()
                ...
                -- รอจนกว่า ReplicatedStorage.remotes จะโหลดเสร็จสมบูรณ์หลังรีจอย
                ...
                if startDungeonRemote then
                    task.wait(5) -- รอ 5 วินาทีก่อนกดสตาร์ทเกมตามที่ตั้งไว้
